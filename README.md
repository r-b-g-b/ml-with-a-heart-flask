...
{'data': "b'lol'", 'message': 'Invalid JSON'}

# invalid request: missing/extra fields
data = [{'patient_id': 'patient-0',
         'slope_of_peak_exercise_st_segment': 1,
         'thal': 'normal',
         'resting_blood_pressure': 128,
...
{'extra_fields': [[1, ['some_extra_field']]],
 'message': 'Fields do not match model fields',
 'missing_fields': [[0, ['exercise_induced_angina']]]}
